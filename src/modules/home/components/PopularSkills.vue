  ...
  <section class="py-12 md:py-20 bg-[var(--dark-bg)]">
    <div class="max-w-[95rem] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between mb-6 md:mb-12">
        <div>
          <h2 class="text-2xl md:text-4xl font-bold mb-2 text-[var(--text-light)]">热门技能</h2>
          <p class="text-sm md:text-lg text-[var(--text-muted)]">最受欢迎的 AI Skills</p>
        </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6">
